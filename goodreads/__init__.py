class Goodreads(object):
    ...
    def author_books(self,):
        ...
        self.get('author/list.xml')
        # Parameters:     key: Developer key (required).    id: Goodreads Author id (required)    page: 1-N (default 1)                        
    ...
    def author_show(self,):
        ...
        self.get('author/show.xml')
        # Parameters:     key: Developer key (required).    id: Goodreads Author id.                            
